...
import { incrementProducts, decrementAmountProducts, clearProducts } from '../../redux/slices/productSlice';
    ...
    <section className="cart">
      <div className="container cart__container">
        ...
        {totallyAmountProducts === 0 
          ...
          : <>
            <button onClick={() => setActiveModal(true)} className="cart__button-buy button">
